...
public class PopupDialog extends AlertDialog {
	...
	protected PopupDialog(Context context, boolean cancelable, boolean canceledOnTouchOutside) {
		...
		view = inflater.inflate(ResHelper.getLayoutRes(context, "smssdk_popup_dialog"), null);
		initView();
	}
	...
	private void initView() {
		this.title = (TextView) view.findViewById(ResHelper.getIdRes(context, "common_dialog_title_tv"));
		this.close = (ImageView) view.findViewById(ResHelper.getIdRes(context, "common_dialog_close_iv"));
		this.msg = (TextView) view.findViewById(ResHelper.getIdRes(context, "common_dialog_message_tv"));
		// Set Scrollable
		this.msg.setMovementMethod(ScrollingMovementMethod.getInstance());
		this.confirm = (TextView) view.findViewById(ResHelper.getIdRes(context, "common_dialog_confirm_tv"));
		this.cancel = (TextView) view.findViewById(ResHelper.getIdRes(context, "common_dialog_cancel_tv"));
		this.bottomLl = (LinearLayout) view.findViewById(ResHelper.getIdRes(context, "common_dialog_bottom_ll"));
		this.topRl = (RelativeLayout) view.findViewById(ResHelper.getIdRes(context, "common_dialog_top_rl"));
		this.verticalLine = view.findViewById(ResHelper.getIdRes(context, "common_dialog_vertical_line"));
